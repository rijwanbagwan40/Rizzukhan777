...
const templateUrl = "https://i.ibb.co/Z6YQSPr5/b9946659be99.jpg";
...
const romanticMessages = [
  "𝐓𝐮𝐦 𝐦𝐞𝐫𝐢 𝐳𝐢𝐧𝐝𝐚𝐠𝐢 𝐤𝐚 𝐬𝐛 𝐬𝐞 𝐡𝐚𝐬𝐞𝐞𝐧 𝐭𝐨𝐡𝐟𝐚 𝐡𝐨,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐛𝐢𝐧𝐚 𝐦𝐞𝐫𝐢 𝐤𝐨𝐢 𝐤𝐡𝐮𝐬𝐡𝐢 𝐦𝐮𝐤𝐚𝐦𝐦𝐚𝐥 𝐧𝐚𝐡𝐢 💕",
  "𝐓𝐮𝐦𝐡𝐚𝐫𝐚 𝐩𝐲𝐚𝐚𝐫 𝐦𝐞𝐫𝐢 𝐝𝐨𝐥𝐚𝐭 𝐡𝐚𝐢,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐢 𝐜𝐡𝐚𝐡𝐚𝐭 𝐦𝐞𝐫𝐢 𝐢𝐛𝐚𝐝𝐚𝐭 𝐡𝐚𝐢 💖",
  "𝐌𝐞𝐫𝐞 𝐝𝐢𝐥 𝐤𝐢 𝐝𝐮𝐧𝐢𝐲𝐚 𝐦𝐞𝐢𝐧 𝐬𝐢𝐫𝐟 𝐭𝐮𝐦 𝐡𝐨,\n𝐦𝐞𝐫𝐢 𝐡𝐚𝐫 𝐝𝐮𝐚 𝐦𝐞𝐢𝐧 𝐬𝐢𝐫𝐟 𝐭𝐮𝐦𝐡𝐚𝐫𝐚 𝐳𝐢𝐤𝐫 𝐡𝐚𝐢 🌹",
  "𝐓𝐮𝐦 𝐦𝐞𝐫𝐢 𝐫𝐨𝐨𝐡 𝐤𝐚 𝐬𝐮𝐤𝐨𝐨𝐧 𝐡𝐨,\n𝐦𝐞𝐫𝐞 𝐝𝐢𝐥 𝐤𝐢 𝐝𝐡𝐚𝐝𝐤𝐚𝐧 𝐡𝐨 💝",
  "𝐓𝐮𝐦𝐬𝐞 𝐩𝐲𝐚𝐚𝐫 𝐤𝐚𝐫𝐧𝐚 𝐦𝐞𝐫𝐢 𝐟𝐢𝐭𝐫𝐚𝐭 𝐡𝐚𝐢,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐚 𝐬𝐚𝐚𝐭𝐡 𝐦𝐞𝐫𝐢 𝐳𝐚𝐫𝐨𝐨𝐫𝐚𝐭 𝐡𝐚𝐢 ☀️💕"
];
...
module.exports.run = async ({ api, event, Users, Currencies }) => {
  ...
  try {
    ...
    const circleOne = await makeCircularImage(avatarOne, 250);
    const circleTwo = await makeCircularImage(avatarTwo, 250);

    const template = await Jimp.read(templatePath);

    template.composite(circleOne, 55, 205);
    template.composite(circleTwo, 565, 25);
