...
const templateUrl = "https://i.ibb.co/Jw0tQvtD/69c73e098eb0.jpg";
...
const romanticMessages = [
  "𝐈𝐬𝐡𝐪 𝐤𝐢 𝐢𝐬 𝐫𝐚𝐚𝐡 𝐦𝐞𝐢𝐧 𝐭𝐮𝐦 𝐦𝐞𝐫𝐞 𝐡𝐮𝐦𝐬𝐚𝐟𝐚𝐫 𝐡𝐨,\n𝐦𝐞𝐫𝐢 𝐡𝐚𝐫 𝐦𝐚𝐧𝐳𝐢𝐥 𝐤𝐚 𝐭𝐮𝐦 𝐡𝐢 𝐚𝐚𝐤𝐡𝐢𝐫 𝐡𝐨 💕",
  "𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐢𝐬𝐡𝐪 𝐦𝐞𝐢𝐧 𝐦𝐚𝐢𝐧 𝐢𝐭𝐧𝐚 𝐤𝐡𝐨 𝐠𝐚𝐲𝐚,\n𝐤𝐞 𝐚𝐩𝐧𝐚 𝐚𝐚𝐩 𝐛𝐡𝐢 𝐦𝐮𝐣𝐡𝐞 𝐲𝐚𝐚𝐝 𝐧𝐚𝐡𝐢 𝐫𝐚𝐡𝐚 💖",
  "𝐓𝐮𝐦 𝐦𝐞𝐫𝐢 𝐦𝐮𝐤𝐚𝐦𝐦𝐚𝐥 𝐤𝐚𝐡𝐚𝐧𝐢 𝐡𝐨,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐛𝐢𝐧𝐚 𝐦𝐞𝐫𝐢 𝐳𝐢𝐧𝐝𝐚𝐠𝐢 𝐚𝐝𝐡𝐨𝐨𝐫𝐢 𝐡𝐚𝐢 🌹",
  "𝐓𝐮𝐦 𝐬𝐞 𝐦𝐢𝐥𝐤𝐚𝐫 𝐣𝐚𝐚𝐧𝐚 𝐤𝐲𝐚 𝐡𝐨𝐭𝐚 𝐡𝐚𝐢 𝐩𝐲𝐚𝐚𝐫,\n𝐚𝐛 𝐭𝐨 𝐛𝐚𝐬 𝐭𝐮𝐦𝐡𝐚𝐫𝐚 𝐡𝐢 𝐢𝐧𝐭𝐞𝐳𝐚𝐚𝐫 𝐡𝐚𝐢 💝",
  "𝐉𝐚𝐛 𝐬𝐞 𝐭𝐮𝐦 𝐦𝐢𝐥𝐞 𝐡𝐨 𝐳𝐢𝐧𝐝𝐚𝐠𝐢 𝐛𝐚𝐝𝐚𝐥 𝐠𝐚𝐲𝐢,\n𝐡𝐚𝐫 𝐤𝐡𝐮𝐬𝐡𝐢 𝐚𝐛 𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐬𝐚𝐚𝐭𝐡 𝐡𝐢 𝐦𝐮𝐤𝐚𝐦𝐦𝐚𝐥 𝐡𝐚𝐢 ☀️💕"
];
...
module.exports.run = async ({ api, event, Users, Currencies }) => {
  ...
  try {
    ...
    if (balance < COST) {
      return api.sendMessage(`≿━━━━༺❀༻━━━━≾\n❌ 𝐀𝐚𝐩 𝐤𝐞 𝐩𝐚𝐚𝐬 𝐤𝐚𝐚𝐟𝐢 𝐛𝐚𝐥𝐚𝐧𝐜𝐞 𝐧𝐚𝐡𝐢 𝐡𝐚𝐢!\n\n💰 Required: $${COST}\n💵 Your Balance: $${balance}\n\n𝐃𝐚𝐢𝐥𝐲 𝐲𝐚 𝐖𝐨𝐫𝐤 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐬𝐞 𝐛𝐚𝐥𝐚𝐧𝐜𝐞 𝐥𝐞𝐢𝐧!\n≿━━━━༺❀༻━━━━≾`, threadID, messageID);
    }

    Currencies.removeBalance(senderID, COST);
    ...
    if (mention[0]) {
      ...
      if (filteredMembers.length === 0) {
        Currencies.addBalance(senderID, COST);
    ...
    const circleOne = await makeCircularImage(avatarOne, 190);
    const circleTwo = await makeCircularImage(avatarTwo, 190);

    const template = await Jimp.read(templatePath);

    template.composite(circleOne, 178, 140);
    template.composite(circleTwo, 450, 150);

    const outputPath = path.join(cacheDir, `pair7_${one}_${two}_${Date.now()}.png`);
    await template.write(outputPath);

    let mentionNameTwo = mention[0] ? event.mentions[mention[0]] : null;
    let nameOne = await getProperName(api, one, Users);
    let nameTwo = await getProperName(api, two, Users, mentionNameTwo);
    const randomMsg = romanticMessages[Math.floor(Math.random() * romanticMessages.length)];
    const loveRatio = getLoveRatio();

    api.sendMessage(
      {
        body: `≿━━━━༺💝༻━━━━≾\n\n${randomMsg}\n\n👤 ${nameOne}\n💕 𝐏𝐀𝐈𝐑𝐄𝐃 𝐖𝐈𝐓𝐇 💕\n👤 ${nameTwo}\n\n❤️ 𝐋𝐨𝐯𝐞 𝐑𝐚𝐭𝐢𝐨: ${loveRatio}%\n💰 𝐂𝐨𝐬𝐭: $${COST}\n\n≿━━━━༺💝༻━━━━≾`,
