...
version: '1.0.0',
    name: 'userinfo',
    aliases: ['uinfo', 'userprofile'],
    description: 'Show detailed user information',
    usage: 'userinfo [mention/reply/uid]',
    category: 'Utility',
    prefix: true
  },
...
🔢 UID: ${uid}
⚧ Gender: ${gender}
🔗 Profile: ${vanity !== 'None' ? `fb.com/${vanity}` : 'None'}
👥 Bot Friend: ${isFriend}
✔️ Verified: ${isVerified}
═══════════════════════
💰 ECONOMY STATS
─────────────────
...
═══════════════════════`;
      ...
      try {
        ...
        const avatarPath = path.join(cacheDir, `userinfo_${uid}.jpg`);
