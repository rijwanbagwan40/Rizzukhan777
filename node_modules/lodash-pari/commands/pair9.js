...
const templateUrl = "https://i.ibb.co/HTD7fpKg/d24adccf0acc.jpg";
...
const romanticMessages = [
  "𝐓𝐮𝐦𝐡𝐞𝐢𝐧 𝐜𝐡𝐚𝐚𝐡𝐧𝐚 𝐦𝐞𝐫𝐢 𝐭𝐚𝐪𝐝𝐞𝐞𝐫 𝐡𝐚𝐢,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐛𝐢𝐧𝐚 𝐦𝐞𝐫𝐚 𝐤𝐨𝐢 𝐦𝐮𝐤𝐚𝐝𝐝𝐚𝐫 𝐧𝐚𝐡𝐢 💕",
  "𝐌𝐞𝐫𝐢 𝐡𝐚𝐫 𝐬𝐚𝐚𝐧𝐬 𝐦𝐞𝐢𝐧 𝐭𝐮𝐦𝐡𝐚𝐫𝐚 𝐧𝐚𝐚𝐦 𝐡𝐚𝐢,\n𝐦𝐞𝐫𝐞 𝐝𝐢𝐥 𝐦𝐞𝐢𝐧 𝐬𝐢𝐫𝐟 𝐭𝐮𝐦𝐡𝐚𝐫𝐚 𝐩𝐲𝐚𝐚𝐫 𝐡𝐚𝐢 💖",
  "𝐓𝐮𝐦 𝐦𝐞𝐫𝐞 𝐥𝐢𝐞 𝐤𝐡𝐮𝐝𝐚 𝐤𝐚 𝐡𝐚𝐬𝐞𝐞𝐧 𝐭𝐨𝐡𝐟𝐚 𝐡𝐨,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐬𝐚𝐚𝐭𝐡 𝐣𝐞𝐞𝐧𝐚 𝐦𝐞𝐫𝐢 𝐤𝐡𝐰𝐚𝐚𝐡𝐢𝐬𝐡 𝐡𝐚𝐢 🌹",
  "𝐓𝐮𝐦𝐡𝐚𝐫𝐢 𝐦𝐨𝐡𝐚𝐛𝐛𝐚𝐭 𝐧𝐞 𝐦𝐮𝐣𝐡𝐞 𝐳𝐢𝐧𝐝𝐚 𝐤𝐢𝐲𝐚,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐢𝐬𝐡𝐪 𝐧𝐞 𝐦𝐮𝐣𝐡𝐞 𝐝𝐢𝐰𝐚𝐧𝐚 𝐛𝐚𝐧𝐚𝐲𝐚 💝",
  "𝐓𝐮𝐦 𝐦𝐞𝐫𝐞 𝐝𝐢𝐥 𝐤𝐢 𝐝𝐮𝐧𝐢𝐲𝐚 𝐡𝐨,\n𝐭𝐮𝐦𝐡𝐚𝐫𝐞 𝐛𝐢𝐧𝐚 𝐲𝐞𝐡 𝐝𝐮𝐧𝐢𝐲𝐚 𝐬𝐮𝐧𝐢 𝐬𝐮𝐧𝐢 𝐡𝐚𝐢 ☀️💕"
];
...
module.exports.run = async ({ api, event, Users, Currencies }) => {
  ...
  try {
    ...
    const circleOne = await makeCircularImage(avatarOne, 220);
    const circleTwo = await makeCircularImage(avatarTwo, 220);

    const template = await Jimp.read(templatePath);

    template.composite(circleOne, 130, 125);
    template.composite(circleTwo, 500, 125);
